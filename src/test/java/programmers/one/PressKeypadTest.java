...
class PressKeypadTest {
  ...
  void test() {
    Assertions.assertEquals(
        "LRLLLRLLRRL", solution(new int[] {1, 3, 4, 5, 8, 2, 1, 4, 5, 9, 5}, "right"));
    Assertions.assertEquals(
        "LRLLRRLLLRR", solution(new int[] {7, 0, 8, 2, 8, 3, 1, 5, 7, 6, 2}, "left"));
    Assertions.assertEquals(
        "LLRLLRLLRL", solution(new int[] {1, 2, 3, 4, 5, 6, 7, 8, 9, 0}, "right"));
  }
