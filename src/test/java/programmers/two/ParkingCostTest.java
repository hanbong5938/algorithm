...
class ParkingCostTest {
    ...
    void test() {
        ...
        Assertions.assertArrayEquals(new int[]{0, 591}, solution(new int[]{120, 0, 60, 591},
                new String[]{"16:00 3961 IN", "16:00 0202 IN", "18:00 3961 OUT", "18:00 0202 OUT", "23:58 3961 IN"}));
        Assertions.assertArrayEquals(new int[]{14841}, solution(new int[]{1, 461, 1, 10},
    ...
    public int[] solution(int[] fees, String[] records) {
        ...
        for (String record : records) {
            ...
            if (inOut.equals("IN")) {
                ...
                int minutes = (time.getHour() * 60 + time.getMinute()) - (inTime.getHour() * 60 + inTime.getMinute());
