...
class HomeworkTest {
    ...
    @Test
    void test() {
        Assertions.assertArrayEquals(new String[]{"korean", "english", "math"}, solution(new String[][]{{"korean", "11:40", "30"}, {"english", "12:10", "20"}, {"math", "12:30", "40"}}));
        Assertions.assertArrayEquals(new String[]{"science", "history", "computer", "music"}, solution(new String[][]{{"science", "12:40", "50"}, {"music", "12:20", "40"}, {"history", "14:00", "30"}, {"computer", "12:30", "100"}}));
        Assertions.assertArrayEquals(new String[]{"bbb", "ccc", "aaa"}, solution(new String[][]{{"aaa", "12:00", "20"}, {"bbb", "12:10", "30"}, {"ccc", "12:40", "10"}}));
    }
    ...
    private void processHomework(PriorityQueue<String[]> queue, Stack<String[]> stack, String[] plan, List<String> answer) {
        ...
        if (!queue.isEmpty()) {
            ...
            if (remainTime > 0) {
                ...
                if (!stack.isEmpty()) {
                    String[] pop = stack.pop();
                    processHomework(queue, stack, new String[]{pop[0], addTime(startTime, Integer.parseInt(time)), pop[2]}, answer);
                }
